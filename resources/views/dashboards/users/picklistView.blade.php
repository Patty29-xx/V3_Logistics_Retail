    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <button type="button" class="close" aria-label="Close" onclick="window.location.href='{{ route('user/picklists.index') }}';">
                ...
                <div class="bottom-nav d-flex">
                    <div class="btn-group mr-2" role="group" aria-label="Button group with nested dropdown">
                        <button type="button" class="btn btn-primary"
                            onclick="window.location.href='{{ route('user/deliveryreceipts.deliveryreceiptForm', ['id' => $picklist->id]) }}';">Mark As Delivery Receipt</button>
