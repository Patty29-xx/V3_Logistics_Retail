        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between">
                    ...
                    <a href="/admin/returnForm" id="createReturn" class="btn btn-primary add-list"><i
                            class="las la-plus mr-3"></i>Return Product</a>
                </div>
            </div>
            <div class="col-md-12">
        ...
        function viewReturn(returnId) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = '/admin/returnView?id=' + returnId;
                },
                error: function(xhr) {
