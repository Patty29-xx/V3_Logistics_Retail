            ...
            <div class="card-body">
                ...
                <form id="inventoryForm" name="inventoryForm">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="price" class="control-label">Supplier</label>
                            <input type="text" class="form-control" id="supplier" name="supplier">
                        </div>

                        <!-- Batch Number Table -->
                        <div class="table-responsive rounded mb-3">
                            <table class="table table-hover batchProduct-table">
                                <thead>
                                    <tr class="ligth ligth-data">
                                        <th>Batch Number</th>
                                ...
                                <tbody class="ligth-body">
                                    <tr>
                                        <td>BT-0001-PO-0001</td>
                                        <td><input type="date" class="form-control" name="production_date[]" required></td>
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '.editInventory', function() {
            ...
            $.get("{{ route('inventories.index') }}" + "/" + inventory_id + "/edit", function(data) {
                $("#modalHeading").html("Inventory Item");
                $('#invModal').modal('show');
